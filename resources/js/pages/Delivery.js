...
const API_GOOGLE_MAPS_KEY = "AIzaSyBGPmf3NoeaxWD0kST7-_kexZREvs2S7Yw";
                    ...
                    <Grid item xs={12} sm={12} md={12} elevation={6} >
                        ...
                        {!errorDirections && (
                            <Map directions={directions}
                                googleMapURL={`https://www.google.com/maps/embed/v1/directions?key=${API_GOOGLE_MAPS_KEY}&origin=&{delivery.target_start}&destination=&{delivery.target_end}`}
                                /*https://maps.googleapis.com/maps/api/js?key=${API_GOOGLE_MAPS_KEY}&v=3.exp&libraries=geometry,drawing,places*/
